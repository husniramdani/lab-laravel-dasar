...
Route::get('/redirect/named', function(){
  // return route('redirect-hello', ['name' => 'Husni']);
  // return url()->route('redirect-hello', ['name' => 'Husni']);
  return URL::route('redirect-hello', ['name' => 'Husni']);
});
...
// contoh grouping route middleware and prefix
Route::middleware(['contoh:SPINDYZEL,401'])->prefix('/middleware')->group(function(){
...
Route::get('/abort/400', function(){
  abort(400, "Waduh Validation Error");
});
